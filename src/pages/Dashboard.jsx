...
import {UploadCloudIcon, PlusIcon,XIcon, FilePenLineIcon, TrashIcon, PencilIcon} from 'lucide-react';
...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, Joe</p>
